...
import 'package:flutter_rust_nn/bridge_generated.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    final val = await api.getValue(
        example: Uint32List.fromList([
      1,
      2,
      3,
      4,
